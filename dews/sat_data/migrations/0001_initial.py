    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('band_path', models.CharField(blank=True, max_length=255, verbose_name='Band path')),
                ...
                ('sat_data', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='band', to='sat_data.satdata')),
            ],
            options={
                'db_table': 'band',
            },
